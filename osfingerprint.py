...
captureInterface   = ["ens2f1","ens5f0"]
...
dhcpfpDB = {
        ...
        '1,121,3,6,15,108,114,119,252' :                           ['Apple iOS or Apple macOS'],
        ...
        '1,121,3,6,15,108,114,119,252,95,44,46' :                  ['Apple macOS'],
...
#                print(str(dhcpOptions[1]))
                opt55 = str()
                i = 0
                for myx in dhcpOptions[1]:
                    if i==0:
                        opt55 = str(myx)
                    else:
                        opt55 += "," + str(myx)
                    i += 1
#                    print(myx)
#                    print("newint:" + str(int(myx, 16)))

#                params    = codecs.encode(str(dhcpOptions[1]),'hex').decode('ascii')
